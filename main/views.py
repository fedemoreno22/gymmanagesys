...
def pricing(request):
	...
	pricing=models.SubPlan.objects.all().order_by('id')
...
def password_change(request):
	...
	return render(request, 'registration/password_change_form',{'form':form,'msg':msg})
...
def pay_success(request):
	...
	from_email='moreno.fede@gmail.com'

	msg = EmailMessage(subject, html_content, from_email, ['moreno.fede@gmail.com'])
